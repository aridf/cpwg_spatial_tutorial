...
This vignette is focused on demonstrating code for setting up and estimating spatial regression models in R. The models are focused on the effect of air quality on home values, with the precise specifications drawn from [Harris & Rubenfield 1978](./literature/harris-and-rubenfield-1978-environmental-economics.pdf)'s original use of the Boston data. that revisits the topic with models estimated in R. 
